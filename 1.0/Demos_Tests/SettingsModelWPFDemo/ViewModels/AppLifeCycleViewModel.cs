    ...
    public class AppLifeCycleViewModel : ViewModelBase
    {
        ...
        public void SaveConfigOnAppClosed()
        {
            ...
            catch (Exception exp)
            {
                ...
                msg.Show(exp, Local.Strings.STR_UnexpectedError_Caption, MsgBoxButtons.OK, MsgBoxImage.Error);
            }
        }
        ...
        public bool Exit_CheckConditions(object sender)
        {
            ...
            {
                logger.Error(exp.Message, exp);
                msg.Show(exp, Local.Strings.STR_UnexpectedError_Caption,
                                MsgBoxButtons.OK, MsgBoxImage.Error, MsgBoxResult.NoDefaultButton);
