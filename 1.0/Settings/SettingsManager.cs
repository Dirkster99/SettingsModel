namespace Settings
{
    ...
    public class SettingsManager : ISettingsManager
    {
        ...
        #region min max and Default definitions for useful option values
        /// <summary>
        ...
        #endregion min max and Default for useful option values
        ...
        public void LoadSessionData(string sessionDataFileName)
        {
            ...
            {
                if (SessionData == null)
                    SessionData = new Profile();  // Just get the defaults if serilization wasn't working here...
            }
        }
